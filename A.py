...
def check_app_settings(expected_result, method, actual_status_code):
    ...
    """Check application settings based on expected result and HTTP method."""
...
def validation_agent():
    """Creates a validation agent using ChatOllama and React Agent."""
    llm = ChatOllama(model="ollama-model-name")  # Replace with your model name
    agent = create_react_agent(llm, tools=[check_app_settings], verbose=True)
    return agent
